                ...
                <div class="col-lg-7" style="padding-bottom:120px">
                    ...
                    <form action="admin/tintuc/edit/{{$tintuc->id}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="TomTat" id="demo" cols="30" rows="3" class="ckeditor" value="">
                                {{$tintuc->TomTat}}
                            </textarea>
                        </div>
                        <div class="form-group">
                            <label for="">Nội dung</label>
                            <textarea name="NoiDung" id="demo" cols="30" rows="4" class="ckeditor" value="">
                                {{$tintuc->NoiDung}}
                            </textarea>
                        </div>
                        <div class="form-group">
                    ...
                    @foreach($tintuc->comment as $cm)
                        <tr class="odd gradeX" align="center">
                            ...
                            <td class="center"><i class="fa fa-trash-o  fa-fw"></i>
                                <a href="admin/comment/delete/{{$cm->id}}/{{$tintuc->id}}">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
